...
public class TagListSelected extends Composite implements TagListSelectedInterface {
	...
	private final TreeMap<String, Composite> tagTree = new TreeMap<>();
	...
	public TagListSelected(Composite parent, int style, Runnable callLayout) {
		super(parent, style);
